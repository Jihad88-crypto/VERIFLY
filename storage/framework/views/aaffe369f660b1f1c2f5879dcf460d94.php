...
unset($__errorArgs, $__bag); ?>" placeholder="Email address" value="<?php echo e(old('email')); ?>" required autofocus>
            </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                <span class="text-danger" style="color: red; font-size: 0.875rem; margin-top: 5px;"><?php echo $message; ?></span>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-footer">
            <span id="login-footer">Don't have an account?</span> <a href="<?php echo e(route('register')); ?>" class="link-accent" id="link-signup">Sign up</a>
          </div>
        </form>
      </div>
...
<?php /**PATH C:\laragon\www\privasi-app\resources\views/ui/login.blade.php ENDPATH**/ ?>