    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-pill {
            ...
            padding: 6px 6px 6px 16px; background: #fff; border-radius: 99px; border: 1px solid rgba(0,0,0,0.05);
        ...
        .page-header h1 { font-family: 'Space Grotesk', sans-serif; font-size: 3.5rem; line-height: 1.1; font-weight: 800; color: #1a1b2e; margin-bottom: 16px; }
        ...
        .card {
            background: var(--glass-bg); border-radius: 20px; padding: 32px 24px; position: relative; overflow: hidden;
            ...
            cursor: pointer; height: 100%; min-height: 280px;
        }
        .card:hover {
            transform: translateY(-8px);
            box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 0 30px rgba(153, 69, 255, 0.2);
            background: rgba(255, 255, 255, 0.85); border-color: rgba(153, 69, 255, 0.4);
        }
        .card:active {
        ...
        .card::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 6px; background: linear-gradient(90deg, var(--primary), var(--secondary)); opacity: 0.8; }
        .card-icon-wrapper {
            width: 56px; height: 56px; border-radius: 12px; background: #fff; display: flex; align-items: center; justify-content: center;
            font-size: 1.4rem; color: var(--primary); box-shadow: 0 8px 16px rgba(0,0,0,0.05); margin-bottom: 8px; position: relative; z-index: 1;
        }
        .card-icon-wrapper::after { content: ''; position: absolute; width: 100%; height: 100%; background: var(--primary); filter: blur(20px); opacity: 0.2; z-index: -1; border-radius: inherit; }
        .card h3 { font-size: 1.25rem; font-weight: 700; color: var(--text-main); }
        .card p { font-size: 0.95rem; line-height: 1.5; color: var(--text-muted); }
        .card-action { margin-top: auto; font-weight: 600; color: var(--primary); display: flex; align-items: center; gap: 8px; font-size: 0.9rem; }
        .card-action span { transition: transform 0.3s; }
        .card:hover .card-action span { transform: translateX(5px); }
...
<body>
    ...
    <div class="container">
        ...
        <div class="grid-cards">
            <!-- 1 Video -->
            <div class="card" onclick="window.location.href='<?php echo e(route('verify.video')); ?>'">
            ...
            <!-- 2 Photo -->
            <div class="card" onclick="window.location.href='<?php echo e(route('verify.image')); ?>'">
            ...
            <!-- 3 Audio -->
            <div class="card" onclick="window.location.href='<?php echo e(route('verify.audio')); ?>'">
            ...
            <!-- 4 API -->
            <div class="card" onclick="window.location.href='<?php echo e(route('developer.api')); ?>'">
            ...
            <!-- 5 History -->
            <div class="card" onclick="window.location.href='<?php echo e(route('activity.logs')); ?>'">
            ...
            <!-- 6 Billing -->
            <div class="card" onclick="window.location.href='<?php echo e(route('billing')); ?>'">
            ...
            <!-- 7 Settings -->
            <div class="card" onclick="window.location.href='<?php echo e(route('settings')); ?>'">
            ...
            <!-- 8 Help -->
            <div class="card" onclick="window.location.href='<?php echo e(route('support')); ?>'">
...
<?php /**PATH C:\laragon\www\privasi-app\resources\views/dashboard.blade.php ENDPATH**/ ?>