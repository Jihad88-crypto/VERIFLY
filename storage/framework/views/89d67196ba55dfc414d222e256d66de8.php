    ...
    <div class="container">
        ...
        <div class="dev-hero">
            <div class="hero-text">
                ...
                <div class="cta-group">
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary" id="btn-get-key">
                        Get API Key 
...
<?php /**PATH C:\laragon\www\privasi-app\resources\views/pages/developers.blade.php ENDPATH**/ ?>