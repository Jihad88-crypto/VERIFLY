                    ...
                    <div class="profile-card enterprise" id="profile-card">
                        ...
                        <div class="avatar-section" style="background: transparent; border: none; padding: 0; box-shadow: none;">
                            ...
                            <div class="avatar-preview">
                                <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=8b5cf6&color=fff&size=128" alt="Avatar" id="user-avatar-img">
                            </div>
                            <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="{{ Auth::user()->name }}" id="in-name">
                        </div>
                        <div class="form-group">
                            <label class="form-label" id="lbl-email">Email Address</label>
                            <input type="email" class="form-input" value="{{ Auth::user()->email }}" id="in-email">
                        </div>
